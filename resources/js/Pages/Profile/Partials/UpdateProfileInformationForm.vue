        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-gray-800">
                    ...
                    >
                        Click aquí para reenvíar el correo de verificación.
                    </Link>
                </p>
                ...
                >
                    Un  nuevo link de verificación ha sido envíado satisfactoriamente a tu dirección de correo electrónico
                </div>
            </div>
